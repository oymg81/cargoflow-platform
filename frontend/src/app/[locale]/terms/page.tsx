      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-neutral-600 space-y-10">
            ...
            {/* Important box matching warning or callout styling */}
            <div className="mt-12 p-6 md:p-8 bg-red-50 rounded-2xl border border-red-100 shadow-sm">
              <h3 className="text-sm font-extrabold text-[#E63946] uppercase tracking-wider mb-3">
                {t('important_title')}
              </h3>
